...
class StateFile:
    ...
    def delete_section(self, section: str):
        """Remove a section and all of its keys from the configuration file if it exists."""
        if self.loaded_cfg.has_section(section):
            self.loaded_cfg.remove_section(section)
